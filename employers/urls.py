...
urlpatterns = [
     path('', views.rec_details, name='detail-employers'),
     ...
     path('jobs/jobreports/', views.job_reports, name='job-reports'),
     path('jobs/jobreports/', views.regenerate_job_report, name='regenerate-report'),
